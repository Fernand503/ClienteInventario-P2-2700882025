...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            SincronizacionService sincronizacion =
                    new SincronizacionService(proveedor, dao);
            ...
            System.out.println("Error de red o JSON: " + e.getMessage());
    ...
    private static void imprimir(List<Producto> productos) {
        ...
        for (Producto p : productos) {
            System.out.printf("%-5d %-35s %10d%n",
